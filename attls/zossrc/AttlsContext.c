...
/**
 * type signature of properties used in AttlsContextImpl in ASCII
 */
...
/**
 * type signature of methods used in AttlsContextImpl in ASCII
 */
...
/**
 * name of properties used in AttlsContextImpl in ASCII
 */
...
/**
 * name of classes used in AttlsContextImpl in ASCII
 */
const char *JNI_CLASS_ATTLS_CONTEXT = "org/zowe/commons/attls/AttlsContextImpl";
...
/**
 * name of method used in AttlsContextImpl in ASCII
 */
...
/**
 * AttlsContextImpl.class to easy using this constant
 */
jclass attls_context_clazz;

/**
 * Cached references to properties of AttlsContextImpl to faster using
 */
 ...
 * It fetches all constant from virtual machine to be used in another methods. It fetches fields of AttlsContextImpl,
...
/**
 * Creates and returns array to store request and answer of ioctl, it is stored in AttlsContextImpl.ioctl
 */
...
void releaseIoctl(JNIEnv *env, jobject obj, struct TTLS_IOCTL* ioctl)
{
    if (ioctl->TTLSi_BufferPtr) {
        jbyteArray certArray = (*env)->GetObjectField(env, obj, buffer_certificate_field);
        (*env)->ReleaseByteArrayElements(env, certArray, (jbyte*) ioctl->TTLSi_BufferPtr, 0);
    }

    jbyteArray ioctlArray = (*env)->GetObjectField(env, obj, ioctl_field);
    (*env)->ReleaseByteArrayElements(env, ioctlArray, (jbyte*) ioctl, 0);
}
...
/**
 * It calls ioctl to fetch query or certificate. Type of call is determinated by arguments query and certificate.
...
/**
 * Clean state of AttlsContextImpl. It remove all cached data. Next call will fetch new one.
 */
JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_clean(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.statPolicyCache
 */
JNIEXPORT jobject JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getStatPolicy(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.statConnCache
 */
JNIEXPORT jobject JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getStatConn(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.protocolCache
 */
JNIEXPORT jobject JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getProtocol(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.negotiatedCipher2Cache
 */
JNIEXPORT jstring JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getNegotiatedCipher2(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.securityTypeCache
 */
JNIEXPORT jobject JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getSecurityType(JNIEnv *env, jobject obj)
{
 ...
 * Return or load and cache value AttlsContextImpl.statPolicyCache
 */
JNIEXPORT jstring JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getUserId(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.fips140Cache
 */
JNIEXPORT jobject JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getFips140(JNIEnv *env, jobject obj)
{
 ...
 */
JNIEXPORT jbyte JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getFlags(JNIEnv *env, jobject obj)
{
    struct TTLS_IOCTL* ioctl = requireQuery(env, obj);
    if ((*env)->ExceptionCheck(env)) {
    releaseIoctl(env, obj, ioctl);
    ...
    jbyte out = (jbyte) ioctl->TTLSi_Flags;
    releaseIoctl(env, obj, ioctl);
    return (jbyte) ioctl->TTLSi_Flags;
}

/**
 * Return or load and cache value AttlsContextImpl.negotiatedCipher4Cache
 */
JNIEXPORT jstring JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getNegotiatedCipher4(JNIEnv *env, jobject obj)
{
...
/**
 * Return or load and cache value AttlsContextImpl.certificateCache
 */
JNIEXPORT jbyteArray JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_getCertificate(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_initConnection(JNIEnv *env, jobject obj)
{
    issueCommand(env, obj, TTLS_INIT_CONNECTION);
}

JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_resetSession(JNIEnv *env, jobject obj)
{
    issueCommand(env, obj, TTLS_RESET_SESSION);
}

JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_resetCipher(JNIEnv *env, jobject obj)
{
    issueCommand(env, obj, TTLS_RESET_CIPHER);
}

JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_stopConnection(JNIEnv *env, jobject obj)
{
    issueCommand(env, obj, TTLS_STOP_CONNECTION);
}

JNIEXPORT void JNICALL Java_org_zowe_commons_attls_AttlsContextImpl_allowHandShakeTimeout(JNIEnv *env, jobject obj)
{
